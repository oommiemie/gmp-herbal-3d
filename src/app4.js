...
var FLOWS=[
 ...
 {id:'dry', label:'สายยาแห้ง: ชั่ง → ผสม → แคปซูล → IPC → ขัดเม็ด → ขวด → ฉลาก → กักกัน FG → ชั้นสินค้า', color:0x8a4fc9,
  pts:[[7.2,2.3],[7.2,3.6],[7.28,5.4],[8.2,6.0],[9.5,5.95],[9.5,4.4],[9.5,3.1],[10.0,3.2],[10.0,4.4],[10.0,5.3],
       ...
       [26.0,5.2],[26.0,4.4],[25.5,4.2],[25.2,3.7],[25.2,2.9],[26.2,2.7],[26.75,3.1]]},
 {id:'liq', label:'สายยาน้ำ: ผสม → A/L → บรรจุ → A/L → คลัง FG', color:0x0f8f8f,
  pts:[[19.6,8.5],[19.6,7.8],[19.0,7.8],[18.25,7.85],[18.05,8.2],[17.9,8.7],[17.9,9.4],[17.95,10.3],
       [18.25,9.7],[18.25,8.7],[18.3,8.1],[18.05,7.6],[17.75,7.0],[17.75,6.7],[19.2,6.7],[21.5,6.7],
       [22.65,6.6],[23.8,6.6],[25.2,6.6],[25.6,6.2],[25.6,5.35],[25.6,4.5],[25.6,3.3],[25.6,2.7]]},
