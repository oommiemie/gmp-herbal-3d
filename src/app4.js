...
// ============================================================
var FLOWS=[
 {id:'in',  label:'วัตถุดิบ: เข้า → กักกัน → สุ่มตัวอย่าง → จัดเก็บ → ชั่ง', color:0x2b6fc2,
  pts:[[-3.4,6.05],[1.0,6.05],[2.2,6.05],[3.5,6.08],[4.25,6.5],[4.25,7.7],[3.72,8.3],
       [4.48,8.1],[4.48,7.5],[4.48,6.5],[5.3,6.05],[7.0,6.08],[7.55,6.45],[7.55,7.8],[7.7,9.3],[7.75,10.3],
       [7.78,9.3],[7.78,7.7],[7.78,6.55],[7.4,6.35],[5.3,6.35],[4.71,6.6],[4.71,7.8],[4.75,9.5],[4.85,10.35],
       [4.94,9.5],[4.94,7.7],[4.94,6.45],[5.6,5.95],[6.8,5.9],[6.8,4.4],[6.8,3.0],[6.95,2.2]]},
 {id:'dry', label:'สายยาแห้ง: ชั่ง → ผสม → แคปซูล → IPC → ขัดเม็ด → ขวด → ฉลาก → กักกัน FG → ชั้นสินค้า', color:0x8a4fc9,
  pts:[[7.2,2.3],[7.2,3.6],[7.28,5.4],[8.2,6.0],[9.5,5.95],[9.5,4.4],[9.5,3.1],[10.0,3.2],[10.0,4.4],[10.0,5.3],
       [10.9,6.0],[12.3,5.95],[12.3,4.4],[12.3,3.3],[12.8,3.4],[12.8,4.4],[12.8,5.3],[13.7,6.0],[14.75,5.9],[14.75,4.4],[14.75,3.2],[15.05,2.6],[15.15,3.3],[15.15,4.4],[15.15,5.4],[16.6,6.0],
       [17.15,5.9],[17.15,4.3],[17.15,2.9],[17.6,3.0],[17.6,4.4],[17.7,5.4],[18.5,6.0],[19.15,5.9],[19.15,4.3],[19.15,2.4],[19.6,2.5],[19.6,4.4],
       [19.6,5.9],[20.9,6.0],[22.1,6.0],[23.0,5.85],[23.0,4.4],[23.0,2.9],[23.0,1.5],
       [23.4,1.6],[23.4,3.0],[23.4,4.4],[23.4,5.5],[24.6,5.9],[25.6,5.7],
       [26.0,5.3],[26.0,4.4],[25.5,4.2],[25.2,3.7],[25.2,2.9],[26.2,2.7],[26.75,3.1]]},
 {id:'liq', label:'สายยาน้ำ: ไลน์ → A/L → ผสม → บรรจุ → ติดฉลาก → กักกัน FG', color:0x0f8f8f,
  pts:[[16.4,6.15],[17.6,6.15],[18.35,6.55],[18.35,7.5],[19.0,7.75],[19.55,7.9],[19.6,8.5],
       [19.75,8.35],[19.75,7.6],[18.75,7.95],[18.2,8.05],[17.9,8.7],[17.9,9.4],[17.95,10.3],
       [18.25,9.7],[18.25,8.7],[18.3,7.9],[17.7,7.5],[17.7,6.6],[19.0,6.6],[21.2,6.6],[22.1,6.5],
       [22.85,5.6],[22.85,4.4],[22.85,3.4],[23.2,3.15],[23.55,3.4],[23.55,4.4],[23.55,5.3],
       [24.3,5.9],[25.7,5.6],[25.7,4.6],[25.25,4.45]]},
 {id:'ppl', label:'บุคลากร: เข้า → เปลี่ยนชุด → ไลน์ผลิต', color:0x148f52,
  pts:[[-2.5,2.4],[0.7,2.4],[1.6,2.0],[2.6,2.4],[3.3,2.5],[3.95,3.1],[4.35,3.7],[4.6,4.3],[4.6,5.4],[5.0,5.75],
       [6.0,5.75],[8.6,5.75]]},
 {id:'pplFG', label:'เบิกสินค้า: ประตูจ่าย → เปลี่ยนชุดบน → โซนฟ้า (คลัง FG)', color:0xc9822e,
  pts:[[30.2,5.7],[28.6,5.7],[27.6,5.8],[27.1,6.3],[26.8,6.8],[26.8,7.6],[26.8,9.2],[26.85,10.6],
       [27.15,9.6],[27.15,8.0],[27.25,7.5],[27.25,6.6],[26.3,6.1],[26.3,5.4],[26.3,4.4],[26.45,3.4]]}
];
...
var TOUR_STOPS=[
 ...
 {id:'blister', az:10, title:'ห้องขัดเม็ดยา + ห้อง IPC',
  text:'เครื่องขัดเม็ดยาคัดฝุ่นและขัดผิวเม็ดก่อนบรรจุ ข้างห้อง IPC ที่คอยตรวจสอบคุณภาพระหว่างผลิตของทุกสาย'},
 ...
 {id:'liqmix', az:15, title:'สายยาน้ำ — ห้องผสมยาน้ำ',
  text:'ถังผสมยาน้ำสแตนเลสพร้อมแผงควบคุม — ไม่มีประตูออกไลน์ เข้าออกผ่านแอร์ล็อกร่วมของสายยาน้ำเท่านั้น'},
 {id:'liqfill', az:0, title:'ห้องบรรจุยาน้ำ — มีแอร์ล็อกของตัวเอง',
  text:'จุดบรรจุสัมผัสยาโดยตรง เข้าได้ทางแอร์ล็อกร่วม (A/L สองทาง: บรรจุ/ผสม) ตามข้อกำหนดแยกโซนด้วยแอร์ล็อก'},
