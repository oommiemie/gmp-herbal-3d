...
var ROOMS = [
 ...
 {id:'alin', no:3, th:'A/L ทางเข้าวัตถุดิบ', en:'Airlock · Material Entry', x0:0,y0:4.8,x1:2.0,y1:7.2, floor:'epoxy', grp:'store',
 ...
 {id:'rm', no:1, th:'ห้องเก็บวัตถุดิบ', en:'Raw Material Store', x0:2.2,y0:7.2,x1:6.6,y1:12, floor:'concrete', grp:'store',
 ...
 {id:'chgN', th:'ห้องเปลี่ยนชุด (บน)', en:'Change Room · North', x0:26.1,y0:7.2,x1:28,y1:12, floor:'vinyl2', grp:'support',
  desc:'ห้องเปลี่ยนชุดฝั่งเหนือ สำหรับพนักงานโซนคลัง/สายยาน้ำ ล็อกเกอร์และม้านั่งก้าวข้าม'},
